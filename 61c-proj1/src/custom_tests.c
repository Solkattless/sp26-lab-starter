...
bool test_is_snake() {
    ...
    for (int i = 0; snake_chars[i] != '\0'; i++) {
        if (!assert_true("is_snake", is_snake(snake_chars[i]))) return false;
    }
...
bool test_get_next_row() {
    if (!assert_equals_unsigned_int("get_next_row('^')", 4, get_next_row(5, '^'))) return false;
    if (!assert_equals_unsigned_int("get_next_row('w')", 4, get_next_row(5, 'w'))) return false;
    if (!assert_equals_unsigned_int("get_next_row('W')", 4, get_next_row(5, 'W'))) return false;
    
    if (!assert_equals_unsigned_int("get_next_row('v')", 6, get_next_row(5, 'v'))) return false;
...
bool test_get_next_col() {
    if (!assert_equals_unsigned_int("get_next_col('<')", 4, get_next_col(5, '<'))) return false;
    if (!assert_equals_unsigned_int("get_next_col('a')", 4, get_next_col(5, 'a'))) return false;
    if (!assert_equals_unsigned_int("get_next_col('A')", 4, get_next_col(5, 'A'))) return false;
    
    if (!assert_equals_unsigned_int("get_next_col('>')", 6, get_next_col(5, '>'))) return false;
    if (!assert_equals_unsigned_int("get_next_col('d')", 6, get_next_col(5, 'd'))) return false;
    if (!assert_equals_unsigned_int("get_next_col('D')", 6, get_next_col(5, 'D'))) return false;
    
    if (!assert_equals_unsigned_int("get_next_col('^')", 5, get_next_col(5, '^'))) return false;
    return true;
}
